...
public class HitSonar extends Module {

    public static HitSonar INSTANCE = new HitSonar();

    private final FloatSetting duration = new FloatSetting("Длительность", 3.0f, 0.5f, 10.0f, 0.1f);
    ...
    public HitSonar() {
        super("HitSonar", "Сканирует при ударе по сущности", ModuleCategory.RENDER);
    ...
    public void onAttack(EventAttackEntity event) {
        ...
        if (target != null) {
            // Запускаем сонар от позиции цели
            ping(target.getPos());
        }
    }
